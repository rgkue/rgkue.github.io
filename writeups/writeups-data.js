...
const writeupsData = [
  ...
  // ── TryHackMe ────────────────────────────────────────────────
  {
   ...
   },
   {
     ...
     difficulty:  "Easy",
     date:        "2026-07-04",
     tags:        ["Enumeration", "Web", "Linux", "Wget"],
     description: "Enumeración de directorios y exfiltación de datos para la creación de usuario privilegiado",
     path:        "contents/TryHackMe/WgelCTF",
     url:         "https://tryhackme.com/room/wgelctf",
     image:       "contents/TryHackMe/WgelCTF/thumb.png",
   },
];
